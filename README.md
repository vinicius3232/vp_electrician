...
| 5 | Escada + Lift | ✅ escada / ⚠️ lift simplificado (estático; elevador móvel = TODO) |
| 6 | Recompensa + XP/level + persistência + hardening | ✅ |

## TODO de fidelidade
- **Minigames: feitos** (solda, painel, fiação). Polimento estético opcional (porta de armário, etc.).
